    ...
    >
      <div>
        ...
        <div>
          ...
          <p className="text-[#545454] w-[569px] mt-2 text-center mx-auto">
        ...
        {/* Input and button */}
        <div className="absolute left-1/2 bottom-[-30px]  -translate-x-1/2 bg-white justify-center items-center gap-4 w-[650px] h-[60px] mx-auto flex shadow-lg rounded-md">
          <Input
